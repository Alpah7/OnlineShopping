<div class="row-fluid">
  <div class="col-md-2 col-sm-4">
    ...
    <ul class="nav nav-pills nav-stacked hidden-xs">
        <li class="list-group-item-heading"><a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"><i class="fa fa-link"></i> Bisnis <i class="pull-right glyphicon glyphicon-chevron-down"></i></a></li>
        <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
          <ul class="nav nav-pills nav-stacked">
            <li><a href="<?= __SHOP__ ?>admin/ordered.php"><i class="fa fa-exchange"></i> Data Order</a></li>
            <li <?php if ($admin->alert_upload_payments() > 0): ?> class="bg-danger" <?php endif ?> >
              <a href="<?= __SHOP__ ?>admin/transactions.php">
                <i class="fa fa-handshake-o"></i> Data Transaksi 
